...
<head>
    ...
    <style type="text/css">
        ...
        #addinfo {
            ...
            text-align: left;
            float: left;
            box-shadow: 0px 0px 35px 2px #DCDCDC;
            position: absolute;
            z-index: 3;
...
<div id="a2">
    ...
    <a href="#" onclick="showAddInput();" id="add">添加班级</a>
</div>
<div class="table">
    <table border="1" style="text-align:center" id="table" cellspacing="0">
        ...
        <tr>
            ...
            <td><a style="color:#6495ED;cursor: pointer;" onclick="updateRow(this);" id="xiu">修改<a>&nbsp<a
                    style="color:chocolate;cursor:pointer;" onclick="delRow(this);" id="xiu">删除</a></td>
        </tr>
        <tr>
            <td>02</td>
            <td>计算机与信息技术</td>
...
<div id="addinfo" style="display: none;" title="点击鼠标以固定，滑动鼠标拖动">
    <form action="/Stuadd" method="post" id="form1">
        <center>
            <div id="h4"><b>~~请添加信息~~</b></div>
        </center>
        <div id="h3">
        ...
        <center>
            ...
            <input type="text" id="xueyuan" placeholder="请输入专业"/><br><!--限制用户名只能用英文 下划线 或数字-->
            <input type="text" id="banji" placeholder="请输入班级"/><br>
            <input type="text" id="name" placeholder="请输入老师"/><br>
