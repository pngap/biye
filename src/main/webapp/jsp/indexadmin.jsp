    ...
    <div class="treebox">
        <ul class="menu">
            <li class="level1">
                ...
                <ul class="level2">
                    <li><a href="banjixx.jsp" target="yem">班级信息</a></li>
            ...
            <li class="level1">
                ...
                <ul class="level2">
                    <li><a href="StuselectALL" target="yem">学生信息</a></li>
            ...
            <li class="level1">
                <a href="#none"><em class="ico ico4"></em>老师管理<i></i></a>
                <ul class="level2">
                    <li><a href="用户信息.html" target="yem">老师信息</a></li>
                    <li><a href="用户信息.html" target="yem">老师添加</a></li>
                </ul>
            </li>
            <li class="level1">
            ...
            <li class="level1">
                ...
                <ul class="level2">
                    <li><a href="xiugaimima.jsp" target="yem">教师反馈</a></li>
                    <li><a href="xiugaimima.jsp" target="yem">学生反馈</a></li>
                </ul>
            </li>
        </ul>
    </div>
